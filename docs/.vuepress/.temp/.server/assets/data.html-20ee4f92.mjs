...
const _imports_0 = "/runtime/assets/sc02-14ec6d88.png";
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="数据结构" tabindex="-1"><a class="header-anchor" href="#数据结构" aria-hidden="true">#</a> 数据结构</h1><p><img${ssrRenderAttr("src", _imports_0)} alt="数据结构图"></p><h2 id="参数说明" tabindex="-1"><a class="header-anchor" href="#参数说明" aria-hidden="true">#</a> 参数说明</h2><h3 id="app配置" tabindex="-1"><a class="header-anchor" href="#app配置" aria-hidden="true">#</a> app配置</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">{</span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/guide/data.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const data_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "data.html.vue"]]);
export {
  data_html as default
};
