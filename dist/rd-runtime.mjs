...
import { getCurrentInstance as lt, isReactive as KA, reactive as U, ref as Hg, watch as RI, shallowReactive as Dt, computed as JI, resolveComponent as ut, h as R, onMounted as mI, onUnmounted as YI, isVNode as ft, provide as dt, toRefs as yt, isRef as wt, createApp as pt } from "vue";
function Gt(g, A) {
...
const sA = "active", YA = "passive", nA = "hidden", aA = "frozen", Mg = "terminated", $g = typeof safari == "object" && safari.pushNotification, Rt = "onpageshow" in self, Jt = ["focus", "blur", "visibilitychange", "freeze", "resume", "pageshow", Rt ? "pagehide" : "unload"], AI = (g) => (g.preventDefault(), g.returnValue = "Are you sure?"), mt = (g) => g.reduce((A, I, t) => (A[I] = t, A), {}), Yt = [[sA, YA, nA, Mg], [sA, YA, nA, aA], [nA, YA, sA], [aA, nA], [aA, sA], [aA, YA]].map(mt), Ut = (g, A) => {
  ...
  return [];
}, XA = () => document.visibilityState === nA ? nA : document.hasFocus() ? sA : YA;
class Lt extends Nt {
  constructor() {
    super();
    const A = XA();
    this.s = A, this.i = [], this.a = this.a.bind(this), Jt.forEach((I) => addEventListener(I, this.a, !0)), $g && addEventListener("beforeunload", (I) => {
      this.n = setTimeout(() => {
  ...
  a(A) {
    switch ($g && clearTimeout(this.n), A.type) {
      ...
      case "visibilitychange":
        this.s !== aA && this.s !== Mg && this.r(A, XA());
        break;
      case "freeze":
        this.r(A, aA);
    }
...
(function(g) {
  ...
  C.prototype.eventNames = function() {
    ...
    if (u.fn) {
      switch (u.once && this.removeListener(s, u.fn, void 0, !0), Z) {
        case 1:
          return u.fn.call(u.context), !0;
        case 2:
          return u.fn.call(u.context, n), !0;
        case 3:
          return u.fn.call(u.context, n, a), !0;
        case 4:
          return u.fn.call(u.context, n, a, o), !0;
        case 5:
          return u.fn.call(u.context, n, a, o, l), !0;
        case 6:
          return u.fn.call(u.context, n, a, o, l, D), !0;
      }
      ...
      var Dg = u.length, _;
      for (m = 0; m < Dg; m++)
        switch (u[m].once && this.removeListener(s, u[m].fn, void 0, !0), Z) {
          case 1:
            u[m].fn.call(u[m].context);
            break;
          case 2:
            u[m].fn.call(u[m].context, n);
            break;
          case 3:
            u[m].fn.call(u[m].context, n, a);
            break;
          case 4:
            u[m].fn.call(u[m].context, n, a, o);
            break;
          default:
            if (!W)
    ...
    if (D.fn)
      ...
      for (var G = 0, u = [], Z = D.length; G < Z; G++)
        (D[G].fn !== n || o && !D[G].once || a && D[G].context !== a) && u.push(D[G]);
...
(function(g, A) {
  (function(I, t) {
    ...
    var I = 1e3, t = 6e4, e = 36e5, B = "millisecond", Q = "second", C = "minute", E = "hour", s = "day", n = "week", a = "month", o = "quarter", l = "year", D = "date", G = "Invalid Date", u = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, Z = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, W = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(f) {
      ...
      return { M: a, y: l, w: n, d: s, D, h: E, m: C, s: Q, ms: B, Q: o }[f] || String(f || "").toLowerCase().replace(/s$/, "");
    }, u: function(f) {
      return f === void 0;
    } }, _ = "en", EA = {};
    EA[_] = W;
    var ug = function(f) {
      return f instanceof jA;
    }, TA = function f(h, r, d) {
      var c;
      if (!h)
        return _;
      ...
      return r.date = f, r.args = arguments, new jA(r);
    }, k = Dg;
    k.l = TA, k.i = ug, k.w = function(f, h) {
      return x(f, { locale: h.$L, utc: h.$u, x: h.$x, $offset: h.$offset });
    };
    var jA = function() {
      function f(r) {
        this.$L = TA(r.locale, null, !0), this.parse(r);
      }
      var h = f.prototype;
      return h.parse = function(r) {
        ...
        var c, w = k.p(r), y = "set" + (this.$u ? "UTC" : ""), N = (c = {}, c[s] = y + "Date", c[D] = y + "Date", c[a] = y + "Month", c[l] = y + "FullYear", c[E] = y + "Hours", c[C] = y + "Minutes", c[Q] = y + "Seconds", c[B] = y + "Milliseconds", c)[w], H = w === s ? this.$D + (d - this.$W) : d;
        if (w === a || w === l) {
        ...
        var w = r || "YYYY-MM-DDTHH:mm:ssZ", y = k.z(this), N = this.$H, H = this.$m, L = this.$M, q = c.weekdays, eA = c.months, $ = function(z, BA, fg, _A) {
          return z && (z[BA] || z(d, w)) || fg[BA].slice(0, _A);
        }, SA = function(z) {
          return k.s(N % 12 || 12, z, "0");
        }, RA = c.meridiem || function(z, BA, fg) {
          var _A = z < 12 ? "AM" : "PM";
          return fg ? _A.toLowerCase() : _A;
        ...
        return q = (w = {}, w[l] = q / 12, w[a] = q, w[o] = q / 3, w[n] = (L - H) / 6048e5, w[s] = (L - H) / 864e5, w[E] = L / e, w[C] = L / t, w[Q] = L / I, w)[y] || L, c ? q : k.a(q);
    ...
    return x.prototype = Wg, [["$ms", B], ["$s", Q], ["$m", C], ["$H", E], ["$W", s], ["$M", a], ["$y", l], ["$D", D]].forEach(function(f) {
      Wg[f[1]] = function(h) {
        return this.$g(h, f[0], f[1]);
      };
    }), x.extend = function(f, h) {
      return f.$i || (f(h, jA, x), f.$i = !0), x;
    }, x.locale = TA, x.isDayjs = ug, x.unix = function(f) {
      return x(1e3 * f);
    }, x.en = EA[_], x.Ls = EA, x.p = {}, x;
  });
})(qt);
const Kt = Bg, UI = /* @__PURE__ */ Gt({
  __proto__: null,
  default: Kt
}, [Bg]);
var Ot = typeof UA == "object" && UA && UA.Object === Object && UA, LI = Ot, zt = LI, Tt = typeof self == "object" && self && self.Object === Object && self, jt = zt || Tt || Function("return this")(), rA = jt, _t = rA, Xt = _t.Symbol, bg = Xt, gI = bg, HI = Object.prototype, Zt = HI.hasOwnProperty, Pt = HI.toString, mA = gI ? gI.toStringTag : void 0;
function Vt(g) {
...
var Ie = ge, II = bg, te = Wt, ee = Ie, Be = "[object Null]", Qe = "[object Undefined]", tI = II ? II.toStringTag : void 0;
function ie(g) {
  return g == null ? g === void 0 ? Qe : Be : tI && tI in Object(g) ? te(g) : ee(g);
}
var OA = ie;
function Ce(g, A) {
  return function(I) {
...
var Ee = Ce, se = Ee, ne = se(Object.getPrototypeOf, Object), bI = ne;
function ae(g) {
  return g != null && typeof g == "object";
}
var pA = ae, oe = OA, re = bI, ce = pA, he = "[object Object]", le = Function.prototype, De = Object.prototype, xI = le.toString, ue = De.hasOwnProperty, fe = xI.call(Object);
function de(g) {
  if (!ce(g) || oe(g) != he)
    return !1;
  var A = re(g);
  ...
  return typeof I == "function" && I instanceof I && xI.call(I) == fe;
}
var iA = de;
const eI = {
  dayjs(g, A) {
    return UI(g).format(A);
  }
}, lA = function(g, A, I, t) {
  let e = g;
  if (A) {
...
}, pe = UI, Ge = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createSimpleData: v,
  dayjs: pe,
  extractData: xg,
...
let ZA = null;
function Le() {
  return (ZA === null || ZA.byteLength === 0) && (ZA = new Float64Array(F.memory.buffer)), ZA;
}
let PA = null;
function IA() {
  return (PA === null || PA.byteLength === 0) && (PA = new Int32Array(F.memory.buffer)), PA;
}
let CA = 0, VA = null;
function Ig() {
  return (VA === null || VA.byteLength === 0) && (VA = new Uint8Array(F.memory.buffer)), VA;
}
const He = typeof TextEncoder > "u" ? (0, module.require)("util").TextEncoder : TextEncoder;
let tg = new He("utf-8");
const be = typeof tg.encodeInto == "function" ? function(g, A) {
  return tg.encodeInto(g, A);
} : function(g, A) {
  const I = tg.encode(g);
  return A.set(I), {
    read: g.length,
...
function yA(g, A, I) {
  if (I === void 0) {
    const C = tg.encode(g), E = A(C.length);
    return Ig().subarray(E, E + C.length).set(C), CA = C.length, E;
  }
  ...
  if (Q !== t) {
    ...
    const C = Ig().subarray(e + Q, e + t), E = be(g, C);
    Q += E.written;
  }
  return CA = Q, e;
}
const xe = typeof TextDecoder > "u" ? (0, module.require)("util").TextDecoder : TextDecoder;
let OI = new xe("utf-8", { ignoreBOM: !0, fatal: !0 });
OI.decode();
function ag(g, A) {
  return OI.decode(Ig().subarray(g, g + A));
}
function Sg(g) {
  const A = typeof g;
...
function Ze(g, A) {
  ...
  Le()[g / 8 + 1] = kg(t) ? 0 : t, IA()[g / 4 + 0] = !kg(t);
}
function Pe(g, A) {
...
var KB = Array.isArray, zA = KB, OB = OA, zB = pA, TB = "[object Symbol]";
function jB(g) {
  return typeof g == "symbol" || zB(g) && OB(g) == TB;
}
var Tg = jB, _B = zA, XB = Tg, ZB = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, PB = /^\w*$/;
function VB(g, A) {
  if (_B(g))
    return !1;
  var I = typeof g;
  return I == "number" || I == "symbol" || I == "boolean" || g == null || XB(g) ? !0 : PB.test(g) || !ZB.test(g) || A != null && g in Object(A);
}
var WB = VB;
function $B(g) {
  var A = typeof g;
...
var cA = $B, AQ = OA, gQ = cA, IQ = "[object AsyncFunction]", tQ = "[object Function]", eQ = "[object GeneratorFunction]", BQ = "[object Proxy]";
function QQ(g) {
  if (!gQ(g))
    return !1;
  var A = AQ(g);
  return A == tQ || A == eQ || A == IQ || A == BQ;
}
var jg = QQ, iQ = rA, CQ = iQ["__core-js_shared__"], EQ = CQ, dg = EQ, BI = function() {
...
var nQ = sQ, aQ = Function.prototype, oQ = aQ.toString;
function rQ(g) {
  if (g != null) {
    try {
      return oQ.call(g);
...
var cQ = rQ, hQ = jg, lQ = nQ, DQ = cA, uQ = cQ, fQ = /[\\^$.*+?()[\]{}|]/g, dQ = /^\[object .+?Constructor\]$/, yQ = Function.prototype, wQ = Object.prototype, pQ = yQ.toString, GQ = wQ.hasOwnProperty, MQ = RegExp(
  "^" + pQ.call(GQ).replace(fQ, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function NQ(g) {
  if (!DQ(g) || lQ(g))
    return !1;
...
var SQ = kQ, RQ = FQ, JQ = SQ;
function mQ(g, A) {
  var I = JQ(g, A);
  return RQ(I) ? I : void 0;
}
var _g = mQ, YQ = _g, UQ = YQ(Object, "create"), og = UQ, QI = og;
function LQ() {
...
var xQ = bQ, vQ = og, qQ = "__lodash_hash_undefined__", KQ = Object.prototype, OQ = KQ.hasOwnProperty;
function zQ(g) {
  var A = this.__data__;
  if (vQ) {
    var I = A[g];
    return I === qQ ? void 0 : I;
  }
  return OQ.call(A, g) ? A[g] : void 0;
}
var TQ = zQ, jQ = og, _Q = Object.prototype, XQ = _Q.hasOwnProperty;
function ZQ(g) {
  var A = this.__data__;
  return jQ ? A[g] !== void 0 : XQ.call(A, g);
}
var PQ = ZQ, VQ = og, WQ = "__lodash_hash_undefined__";
function $Q(g, A) {
  var I = this.__data__;
  return this.size += this.has(g) ? 0 : 1, I[g] = VQ && A === void 0 ? WQ : A, this;
}
var Ai = $Q, gi = HQ, Ii = xQ, ti = TQ, ei = PQ, Bi = Ai;
function MA(g) {
...
MA.prototype.clear = gi;
MA.prototype.delete = Ii;
MA.prototype.get = ti;
MA.prototype.has = ei;
MA.prototype.set = Bi;
var Qi = MA;
...
var cg = ni, ai = cg, oi = Array.prototype, ri = oi.splice;
function ci(g) {
  var A = this.__data__, I = ai(A, g);
  if (I < 0)
    return !1;
  var t = A.length - 1;
  return I == t ? A.pop() : ri.call(A, I, 1), --this.size, !0;
}
var hi = ci, li = cg;
function Di(g) {
...
var ui = Di, fi = cg;
function di(g) {
  return fi(this.__data__, g) > -1;
}
var yi = di, wi = cg;
function pi(g, A) {
  var I = this.__data__, t = wi(I, g);
  return t < 0 ? (++this.size, I.push([g, A])) : I[t][1] = A, this;
}
var Gi = pi, Mi = Ci, Ni = hi, Fi = ui, ki = yi, Si = Gi;
function NA(g) {
  var A = -1, I = g == null ? 0 : g.length;
  for (this.clear(); ++A < I; ) {
    var t = g[A];
...
NA.prototype.clear = Mi;
NA.prototype.delete = Ni;
NA.prototype.get = Fi;
NA.prototype.has = ki;
NA.prototype.set = Si;
var hg = NA, Ri = _g, Ji = rA, mi = Ri(Ji, "Map"), TI = mi, iI = Qi, Yi = hg, Ui = TI;
function Li() {
...
function qi(g, A) {
  var I = g.__data__;
  return vi(A) ? I[typeof A == "string" ? "string" : "hash"] : I.map;
}
var lg = qi, Ki = lg;
function Oi(g) {
  var A = Ki(this, g).delete(g);
  return this.size -= A ? 1 : 0, A;
}
var zi = Oi, Ti = lg;
function ji(g) {
  return Ti(this, g).get(g);
}
var _i = ji, Xi = lg;
function Zi(g) {
  return Xi(this, g).has(g);
}
var Pi = Zi, Vi = lg;
function Wi(g, A) {
  var I = Vi(this, g), t = I.size;
  return I.set(g, A), this.size += I.size == t ? 0 : 1, this;
}
var $i = Wi, AC = Hi, gC = zi, IC = _i, tC = Pi, eC = $i;
function FA(g) {
  var A = -1, I = g == null ? 0 : g.length;
  for (this.clear(); ++A < I; ) {
    var t = g[A];
...
FA.prototype.clear = AC;
FA.prototype.delete = gC;
FA.prototype.get = IC;
FA.prototype.has = tC;
FA.prototype.set = eC;
var jI = FA, _I = jI, BC = "Expected a function";
function Xg(g, A) {
  ...
  return I.cache = new (Xg.Cache || _I)(), I;
}
Xg.Cache = _I;
var QC = Xg, iC = QC, CC = 500;
function EC(g) {
  var A = iC(g, function(t) {
    return I.size === CC && I.clear(), t;
  }), I = A.cache;
  return A;
}
var sC = EC, nC = sC, aC = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, oC = /\\(\\)?/g, rC = nC(function(g) {
  var A = [];
  return g.charCodeAt(0) === 46 && A.push(""), g.replace(aC, function(I, t, e, B) {
    A.push(e ? B.replace(oC, "$1") : t || I);
  }), A;
}), cC = rC;
function hC(g, A) {
...
var lC = hC, CI = bg, DC = lC, uC = zA, fC = Tg, dC = 1 / 0, EI = CI ? CI.prototype : void 0, sI = EI ? EI.toString : void 0;
function XI(g) {
  if (typeof g == "string")
    return g;
  if (uC(g))
  ...
  if (fC(g))
    return sI ? sI.call(g) : "";
  var A = g + "";
  return A == "0" && 1 / g == -dC ? "-0" : A;
}
var yC = XI, wC = yC;
function pC(g) {
  return g == null ? "" : wC(g);
}
var GC = pC, MC = zA, NC = WB, FC = cC, kC = GC;
function SC(g, A) {
  return MC(g) ? g : NC(g, A) ? [g] : FC(kC(g));
}
var RC = SC, JC = Tg, mC = 1 / 0;
function YC(g) {
  if (typeof g == "string" || JC(g))
    return g;
  var A = g + "";
  return A == "0" && 1 / g == -mC ? "-0" : A;
}
var UC = YC, LC = RC, HC = UC;
function bC(g, A) {
  A = LC(A, g);
  ...
  return g && Array.isArray(g) && g.forEach((I) => {
    if (iA(I))
      if (typeof I.value == "string" && I.key) {
        ...
        t ? KA(t) ? A[I.key] = I.path ? bA(t.data, I.path) : t.data || t : A[I.key] = I.path ? bA(t, I.path) : t : A[I.key] = I.value;
      } else
...
class zC extends fA {
  constructor(A, I = {}) {
    ...
    let s = OC({ url: e, body: Q, method: C }, this);
    s.on("request", () => {
  ...
  setData(A = {}) {
    A.url && (this.url = A.url, this.req.options.url = A.url), A.method && (this.method = A.method, this.req.options.method = A.method), A.body && (this.body = A.body, this.req.options.body = A.body), vB(A.itval) && (this.itval = A.itval);
  }
  // 修改规则
  setExtractRule(A) {
  ...
  unbindGroup(A, I = !0) {
    ...
    if (A && C && C.components) {
      ...
      if (Array.isArray(a) && a.length > 0) {
        ...
        let o = a.findIndex((D) => D.id == C.id) + 1, l = n.length;
        for (let D = o, G = a.length; D < G; D++) {
          let u = t[a[D].id];
          u && (u.zIndex += l);
        }
      }
      return this.delGroup(A), n.forEach((o, l) => {
        t[o.id].x += C.x, t[o.id].y += C.y, t[o.id].gpid = null, t[o.id].zIndex = E + l, s.push(o.id), I && e.addElement(Q[o.id], o.mid);
      }), s;
    }
    return !1;
  }
...
class EE {
  ...
  // 返回模块内元素的当前最大深度
  getMaxZIndex(A) {
    return qI(this.getMyElements(A));
  }
  // 清空所有内容数据
  clearData() {
...
class nE {
  ...
  // 填充数据
  fillData(A) {
    this.addGData({ id: "GD_query", name: "url参数", type: "temp", value: { data: KI() } }), Array.isArray(A) && A.forEach((I) => {
      this.addGData(I);
    });
  }
  /**
...
function Jg(g, A) {
  function I(e, B, Q) {
    if (!(typeof document > "u")) {
      Q = WA({}, A, Q), typeof Q.expires == "number" && (Q.expires = new Date(Date.now() + Q.expires * 864e5)), Q.expires && (Q.expires = Q.expires.toUTCString()), e = encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape);
      var C = "";
      for (var E in Q)
  ...
  return Object.create(
    {
      ...
      withAttributes: function(e) {
        return Jg(this.converter, WA({}, this.attributes, e));
      },
      withConverter: function(e) {
        return Jg(WA({}, this.converter, e), this.attributes);
      }
    },
    {
...
class fE {
  ...
  filterDatas = {};
  constructor(A, I) {
    this.app = A, Object.assign(this.AppSetup, I), this.scale = U({ value: 1, h: 1, w: 1 }), this.transform = lE.call(this), this.mData = new EE(this), this.aData = new sE(this), this.eData = new aE(this), this.rData = new oE(this), this.gData = new nE(this), this.pData = new rE(this);
  }
  init(A) {
  ...
  resetScale() {
    ...
    Object.assign(this.scale, vI(this.AppSetup.dom, A));
  }
  // 拆分数据
  splitData(A) {
    this.iData = {};
...
const $A = function(g, A, I, t) {
  ...
  mI(() => {
    ...
    }), g.value && g.value.el && (t = g.value.el, $A(t, "timeout", g.value, "mounted"), $A(t, "interval", g.value, "mounted"));
  }), YI(() => {
    A.id && p.removeEventListener(`run_function_${A.id}`), t && ($A(t, "timeout", g.value, "beforeUnmount"), $A(t, "interval", g.value, "beforeUnmount"));
  });
}, ME = function(g) {
  mI(() => {
...
const tA = {
  ...
  mounted() {
    Ag(this.$el, "timeout", this, "mounted"), Ag(this.$el, "interval", this, "mounted");
  },
  beforeUnmount() {
    this.id && p.removeEventListener(`run_function_${this.id}`), Ag(this.$el, "timeout", this, "beforeUnmount"), Ag(this.$el, "interval", this, "beforeUnmount");
  }
};
function FE(g) {
...
function gt(g, { id: A, myApp: I }) {
  const t = FE(g), e = mg({ myApp: I, events: g.events || [], data: g, componentName: "" }), B = ["element_sprite", { element_selected: g.selected }, { element_hover: g.hover }];
...
const vA = {
  ...
  setup(g, A) {
    ...
    return dt("rect", Q), GE(I, g), () => {
      const C = e.getElement(g.id);
      Q.x = C.x, Q.y = C.y, Q.width = C.width, Q.height = C.height;
      let E = gt(C, { id: g.id, myApp: { AppSetup: t, data: e, component: B } }), s = j({ name: C.name, props: C.id, ref: I.child });
  ...
  setup(g) {
    ...
    return (e) => {
      ...
      B.data && (C = I.getDataSource(B.data), C && KA(C) && (C = C.data)), g.layout && g.layout.type == "grid" && (Q.style.position = "relative", Q.style.top = "auto", Q.style.left = "auto");
      const E = [];
...
}, OE = [kE, SE, RE, HE, mE, UE, xE, vE, KE, Yg, vA], zE = {
  install: (g) => {
    OE.forEach((A) => {
...
var $E = WE, As = hg, gs = TI, Is = jI, ts = 200;
function es(g, A) {
  var I = this.__data__;
  if (I instanceof As) {
    var t = I.__data__;
...
var Bs = es, Qs = hg, is = _E, Cs = ZE, Es = VE, ss = $E, ns = Bs;
function kA(g) {
  var A = this.__data__ = new Qs(g);
  this.size = A.size;
}
kA.prototype.clear = is;
kA.prototype.delete = Cs;
kA.prototype.get = Es;
kA.prototype.has = ss;
kA.prototype.set = ns;
var as = kA, os = _g, rs = function() {
  try {
    var g = os(Object, "defineProperty");
    return g({}, "", {}), g;
  } catch {
  }
}(), It = rs, hI = It;
...
var Zg = cs, hs = Zg, ls = rg;
function Ds(g, A, I) {
  (I !== void 0 && !ls(g[A], I) || I === void 0 && !(A in g)) && hs(g, A, I);
}
var tt = Ds;
function us(g) {
...
var fs = us, ds = fs, ys = ds(), ws = ys, Cg = {}, ps = {
  get exports() {
    return Cg;
  },
  set exports(g) {
...
var Gs = rA, Ms = Gs.Uint8Array, Ns = Ms, lI = Ns;
function Fs(g) {
...
var Ys = ms, Us = cA, DI = Object.create, Ls = function() {
  function g() {
  }
  return function(A) {
    if (!Us(A))
...
}(), Hs = Ls, bs = Object.prototype;
function xs(g) {
  var A = g && g.constructor, I = typeof A == "function" && A.prototype || bs;
  return g === I;
}
var et = xs, vs = Hs, qs = bI, Ks = et;
function Os(g) {
  return typeof g.constructor == "function" && !Ks(g) ? vs(qs(g)) : {};
}
var zs = Os, Ts = OA, js = pA, _s = "[object Arguments]";
function Xs(g) {
  return js(g) && Ts(g) == _s;
}
var Zs = Xs, uI = Zs, Ps = pA, Bt = Object.prototype, Vs = Bt.hasOwnProperty, Ws = Bt.propertyIsEnumerable, $s = uI(function() {
  return arguments;
}()) ? uI : function(g) {
  return Ps(g) && Vs.call(g, "callee") && !Ws.call(g, "callee");
}, Qt = $s, An = 9007199254740991;
function gn(g) {
  return typeof g == "number" && g > -1 && g % 1 == 0 && g <= An;
}
var it = gn, In = jg, tn = it;
function en(g) {
  return g != null && tn(g.length) && !In(g);
}
var Pg = en, Bn = Pg, Qn = pA;
function Cn(g) {
  return Qn(g) && Bn(g);
}
var En = Cn, qA = {}, sn = {
...
var an = nn;
(function(g, A) {
  var I = rA, t = an, e = A && !A.nodeType && A, B = e && !0 && g && !g.nodeType && g, Q = B && B.exports === e, C = Q ? I.Buffer : void 0, E = C ? C.isBuffer : void 0, s = E || t;
  g.exports = s;
})(sn, qA);
var on = OA, rn = it, cn = pA, hn = "[object Arguments]", ln = "[object Array]", Dn = "[object Boolean]", un = "[object Date]", fn = "[object Error]", dn = "[object Function]", yn = "[object Map]", wn = "[object Number]", pn = "[object Object]", Gn = "[object RegExp]", Mn = "[object Set]", Nn = "[object String]", Fn = "[object WeakMap]", kn = "[object ArrayBuffer]", Sn = "[object DataView]", Rn = "[object Float32Array]", Jn = "[object Float64Array]", mn = "[object Int8Array]", Yn = "[object Int16Array]", Un = "[object Int32Array]", Ln = "[object Uint8Array]", Hn = "[object Uint8ClampedArray]", bn = "[object Uint16Array]", xn = "[object Uint32Array]", J = {};
J[Rn] = J[Jn] = J[mn] = J[Yn] = J[Un] = J[Ln] = J[Hn] = J[bn] = J[xn] = !0;
J[hn] = J[ln] = J[kn] = J[Dn] = J[Sn] = J[un] = J[fn] = J[dn] = J[yn] = J[wn] = J[pn] = J[Gn] = J[Mn] = J[Nn] = J[Fn] = !1;
function vn(g) {
  return cn(g) && rn(g.length) && !!J[on(g)];
}
var qn = vn;
function Kn(g) {
  return function(A) {
...
(function(g, A) {
  var I = LI, t = A && !A.nodeType && A, e = t && !0 && g && !g.nodeType && g, B = e && e.exports === t, Q = B && I.process, C = function() {
    try {
...
var Tn = qn, jn = On, fI = Eg, dI = fI && fI.isTypedArray, _n = dI ? jn(dI) : Tn, Ct = _n;
function Xn(g, A) {
  if (!(A === "constructor" && typeof g[A] == "function") && A != "__proto__")
    return g[A];
}
var Et = Xn, Zn = Zg, Pn = rg, Vn = Object.prototype, Wn = Vn.hasOwnProperty;
function $n(g, A, I) {
  var t = g[A];
  (!(Wn.call(g, A) && Pn(t, I)) || I === void 0 && !(A in g)) && Zn(g, A, I);
}
var Aa = $n, ga = Aa, Ia = Zg;
function ta(g, A, I, t) {
  var e = !I;
  I || (I = {});
...
var st = Ea, sa = Qa, na = Qt, aa = zA, oa = qA, ra = st, ca = Ct, ha = Object.prototype, la = ha.hasOwnProperty;
function Da(g, A) {
  var I = aa(g), t = !I && na(g), e = !I && !t && oa(g), B = !I && !t && !e && ca(g), Q = I || t || e || B, C = Q ? sa(g.length, String) : [], E = C.length;
  for (var s in g)
    (A || la.call(g, s)) && !(Q && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var Fa = Na, ka = ua, Sa = Fa, Ra = Pg;
function Ja(g) {
  return Ra(g) ? ka(g, !0) : Sa(g);
}
var nt = Ja, ma = ea, Ya = nt;
function Ua(g) {
  return ma(g, Ya(g));
}
var La = Ua, yI = tt, Ha = Cg, ba = Js, xa = Ys, va = zs, wI = Qt, pI = zA, qa = En, Ka = qA, Oa = jg, za = cA, Ta = iA, ja = Ct, GI = Et, _a = La;
function Xa(g, A, I, t, e, B, Q) {
  ...
  if (a) {
    var o = pI(E), l = !o && Ka(E), D = !o && !l && ja(E);
    n = E, o || l || D ? pI(C) ? n = C : qa(C) ? n = xa(C) : l ? (a = !1, n = Ha(E, !0)) : D ? (a = !1, n = ba(E, !0)) : n = [] : Ta(E) || wI(E) ? (n = C, wI(C) ? n = _a(C) : (!za(C) || Oa(C)) && (n = va(E))) : a = !1;
  }
  a && (Q.set(E, n), e(n, E, t, B, Q), Q.delete(E)), yI(g, I, n);
}
var Za = Xa, Pa = as, Va = tt, Wa = ws, $a = Za, Ao = cA, go = nt, Io = Et;
...
var no = so, ao = no, NI = It, oo = ot, ro = NI ? function(g, A) {
...
var So = ko, Ro = rg, Jo = Pg, mo = st, Yo = cA;
function Uo(g, A, I) {
  if (!Yo(I))
    return !1;
  var t = typeof A;
...
const To = function() {
  return {
    ...
    // 修改数据对象
    setGData(g, A) {
      g && g.value && (wt(g.value) ? g.value.value = A : KA(g.value) ? Object.assign(g.value, A) : g.value = A);
    }
  };
...
function wA(g, A, I) {
  ...
  function B(Q, C) {
    ar(g, function(E) {
      Lg(e, E), Q && Lg({ success: Q, error: C }, E), rt(t, E);
    }, e);
  }
  if (e.returnPromise)
...
class rr extends fA {
  constructor(A = {}) {
    super(), this.id = A.id || T(10), this.vapp = null, this.dom = null, this.component = new zo(this), this.data = new fE(this, A.config), this.controller = Xo(this), this.AppSetup = this.data.AppSetup, this.helper = new sr(this), this.plugin = new or(this), this.appInfo = JI(() => {
...
const Dr = Ge, ur = LB, fr = p, dr = GA, cr = Y, yr = _C, wr = function(g) {
  const {
    ...
    slots: E,
    data: s
  } = g, n = { interaction: t, clickCursor: B, scale: I, dom: A, develop: e }, a = new rr({ config: Object.assign({ dom: A }, n) });
...
console.log("%crd-runtime:2.1.5", "color:#0aa100");
export {
  cr as EVENTS,
  fr as cmd,
  wr as createVapp,
