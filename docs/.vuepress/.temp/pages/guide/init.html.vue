...
<p>内容的维护主要就是以数据为核心的维护</p>
<h2 id="创建应用" tabindex="-1"><a class="header-anchor" href="#创建应用" aria-hidden="true">#</a> 创建应用</h2>
<ul>
<li>创建一个最基础的应用示例app.js</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>   <span class="token keyword">import</span> <span class="token punctuation">{</span> onMounted<span class="token punctuation">,</span> h <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'vue'</span>
   ...
   <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="/guide/data.html#%E6%95%B0%E6%8D%AE%E6%A0%B7%E4%BE%8B" target="_blank" rel="noopener noreferrer">装载数据样例<ExternalLinkIcon/></a><br>
createStage方法创建一个舞台应用并挂载到dom中，参数可以是可读取的dom结构id，也开始是一个实体dom<br>
如果是vue中需要mounted中执行，第二个参数interaction值为是否开启交互动作</p>
<h2 id="创建组件" tabindex="-1"><a class="header-anchor" href="#创建组件" aria-hidden="true">#</a> 创建组件</h2>
<p>除了内置的基础分层组件之外，所有的组件由用户自行创建，并引入到此运行环境中才可使用，所有组件会默认混入<a href="/guide/data.html#%E7%BB%84%E4%BB%B6%E9%BB%98%E8%AE%A4%E6%B7%B7%E5%85%A5" target="_blank" rel="noopener noreferrer">基础参数<ExternalLinkIcon/></a>。创建的组件理论上可以随意定义自身的一些参数事件，但为了更好做组件之间的控制与维护，我们约定尽量参数的使用不要超过默认的混入参数范围。</p>
<h3 id="混入参数" tabindex="-1"><a class="header-anchor" href="#混入参数" aria-hidden="true">#</a> 混入参数</h3>
<ul>
<li><code v-pre>x</code>  横坐标位置 <code v-pre>0</code></li>
<li><code v-pre>y</code>  纵坐标位置 <code v-pre>0</code></li>
<li><code v-pre>width</code> 宽度 <code v-pre>0</code></li>
<li><code v-pre>height</code> 高度 <code v-pre>0</code></li>
<li><code v-pre>zIndex</code> 层级深度 <code v-pre>0</code></li>
<li><code v-pre>background</code> 背景样式对象 <code v-pre>{}</code></li>
<li><code v-pre>border</code> 边框样式对象 <code v-pre>{}</code></li>
<li><code v-pre>visible</code> 是否可见 <code v-pre>true</code></li>
<li><code v-pre>data</code>  传入数据 <code v-pre>''</code></li>
<li><code v-pre>options</code>  附加参数 <code v-pre>{}</code></li>
</ul>
<h3 id="必要配置" tabindex="-1"><a class="header-anchor" href="#必要配置" aria-hidden="true">#</a> 必要配置</h3>
<ul>
<li>
<p>name<br>
必须给组件命名</p>
...
<li>
<p>type<br>
给组件定义类型名，用户组件的分组归类</p>
</li>
<li>
<p>style使用<br>
在组件的dom结构根节点需要绑定style对象</p>
</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="自定义事件" tabindex="-1"><a class="header-anchor" href="#自定义事件" aria-hidden="true">#</a> 自定义事件</h3>
<p>组件可以在emits中设置自定义事件触发名，并发送事件。当你的组件中存在emits数据配置时，通过组件方法getComponentEvents返回定义的事件列表。</p>
<h3 id="示例组件" tabindex="-1"><a class="header-anchor" href="#示例组件" aria-hidden="true">#</a> 示例组件</h3>
<p>box.vue</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="舞台" tabindex="-1"><a class="header-anchor" href="#舞台" aria-hidden="true">#</a> 舞台</h2>
<h3 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h3>
<p>舞台的基本配置全部根据参数而定 <RouterLink to="/guide/data.html#app%E9%85%8D%E7%BD%AE">查看基本参数</RouterLink><br>
通过<code v-pre>rdata.appBase</code>对象来获取和修改配置</p>
...
<li>background 背景
<ul>
<li>{backgroudColor:'颜色值'}
背景参数以css的样式做为参考</li>
</ul>
</li>
</ul>
<h3 id="开启动作交互" tabindex="-1"><a class="header-anchor" href="#开启动作交互" aria-hidden="true">#</a> 开启动作交互</h3>
<p>默认清空渲染到舞台上的元件是没有绑定动作事件，需要主动开启，其他参数<RouterLink to="/base/api.html#createStage">查看接口</RouterLink></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createStage <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
<span class="token function">createStage</span><span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token literal-property property">dom</span><span class="token operator">:</span><span class="token string">"#stage"</span><span class="token punctuation">,</span><span class="token literal-property property">interaction</span><span class="token operator">:</span><span class="token boolean">true</span><span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="元件" tabindex="-1"><a class="header-anchor" href="#元件" aria-hidden="true">#</a> 元件</h2>
<h3 id="id" tabindex="-1"><a class="header-anchor" href="#id" aria-hidden="true">#</a> ID</h3>
<p><strong>id</strong> 作为元件唯一的标识，是围绕元件所有操作的最重要属性。
在创建元件时可以自己附带id属性，如果新建数据的id不存在将自动生成一个值，并赋在元件id属性上。</p>
<p><RouterLink to="/guide/data.html#component%E7%BB%84%E4%BB%B6-%E5%85%83%E4%BB%B6">其他基本数据</RouterLink></p>
<h3 id="新建与添加" tabindex="-1"><a class="header-anchor" href="#新建与添加" aria-hidden="true">#</a> 新建与添加</h3>
<ol>
<li>获取一个组件默认数据<code v-pre>component.getComponentDefaultData()</code></li>
<li>通过组件数据添加一个新元件<code v-pre>rdata.addSpriteData()</code></li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>   <span class="token keyword">import</span> <span class="token punctuation">{</span> component<span class="token punctuation">,</span> rdata <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="删除与编辑" tabindex="-1"><a class="header-anchor" href="#删除与编辑" aria-hidden="true">#</a> 删除与编辑</h3>
<p>通过元件id删除来删除元件，使用<code v-pre>rdata.delSpriteData()</code><br>
元件数据是一个响应式的对象，因此可以直接深层次的修改上面的值，可以修改的值围绕组件定义的props的参数</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 获取某一个元件的数据</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="添加事件" tabindex="-1"><a class="header-anchor" href="#添加事件" aria-hidden="true">#</a> 添加事件</h3>
<ol>
<li>获取事件对象数据格式</li>
<li>选择一个事件对象类型</li>
<li>添加事件到元件</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>   <span class="token keyword">import</span> <span class="token punctuation">{</span> component<span class="token punctuation">,</span> rdata<span class="token punctuation">,</span> typeModel<span class="token punctuation">,</span> helper <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="添加动作" tabindex="-1"><a class="header-anchor" href="#添加动作" aria-hidden="true">#</a> 添加动作</h3>
<ol>
<li>获取动作对象数据格式</li>
<li>编辑动作参数</li>
<li>添加动作到元件的事件中</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="绑定数据" tabindex="-1"><a class="header-anchor" href="#绑定数据" aria-hidden="true">#</a> 绑定数据</h3>
<p>任何元件都有一个默认的data传值，这个参数可以是在数据值可以直接在创建的元件的时候赋值</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 获取某一个元件的数据</span>
<span class="token keyword">let</span> compData<span class="token operator">=</span>rdata<span class="token punctuation">.</span><span class="token function">getSpriteData</span><span class="token punctuation">(</span>id<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>也可以是通过全局的数据配置来绑定，这里需要先通过一个<code v-pre>addGData</code>的方法先创建一个全局数据源，然后将此id赋给元件的data</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> rdata <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="输入与输出数据" tabindex="-1"><a class="header-anchor" href="#输入与输出数据" aria-hidden="true">#</a> 输入与输出数据</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>   <span class="token keyword">import</span> <span class="token punctuation">{</span> rdata <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
