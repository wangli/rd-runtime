...
import { getCurrentInstance as sB, isReactive as pg, reactive as L, ref as Gg, watch as Mg, shallowReactive as nB, computed as aB, resolveComponent as oB, h as U, isVNode as rB, onMounted as Ng, onUnmounted as cB, toRefs as hB, createApp as lB } from "vue";
function DB(I, A) {
...
const sA = "active", JA = "passive", nA = "hidden", aA = "frozen", dI = "terminated", XI = typeof safari == "object" && safari.pushNotification, pB = "onpageshow" in self, GB = ["focus", "blur", "visibilitychange", "freeze", "resume", "pageshow", pB ? "pagehide" : "unload"], ZI = (I) => (I.preventDefault(), I.returnValue = "Are you sure?"), MB = (I) => I.reduce((A, g, B) => (A[g] = B, A), {}), NB = [[sA, JA, nA, dI], [sA, JA, nA, aA], [nA, JA, sA], [aA, nA], [aA, sA], [aA, JA]].map(MB), FB = (I, A) => {
  for (let g, B = 0; g = NB[B]; ++B) {
    const t = g[I], e = g[A];
    if (t >= 0 && e >= 0 && e > t)
...
class kB extends fB {
  constructor() {
    super();
    const A = zA();
    this.s = A, this.i = [], this.a = this.a.bind(this), GB.forEach((g) => addEventListener(g, this.a, !0)), XI && addEventListener("beforeunload", (g) => {
      this.n = setTimeout(() => {
  ...
  r(A, g) {
    if (g !== this.s) {
      const B = this.s, t = FB(B, g);
      for (let e = 0; e < t.length - 1; ++e) {
        const Q = t[e], C = t[e + 1];
        this.s = C, this.dispatchEvent(new yB("statechange", { oldState: Q, newState: C, originalEvent: A }));
      }
    }
  }
  a(A) {
...
var SB = new kB(), mA = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, DA = {}, RB = {
  get exports() {
    return DA;
  },
  set exports(I) {
...
function mB(I) {
  ...
  return kA[I] ? (g - kA[I].time < JB && (A = !1), kA[I].count++, kA[I].time = g) : kA[I] = {
    count: 1,
    time: g
  }, A;
}
...
const UB = AI, Fg = /* @__PURE__ */ DB({
  __proto__: null,
  default: UB
}, [AI]);
var LB = typeof mA == "object" && mA && mA.Object === Object && mA, kg = LB, HB = kg, bB = typeof self == "object" && self && self.Object === Object && self, xB = HB || bB || Function("return this")(), oA = xB, vB = oA, qB = vB.Symbol, JI = qB, PI = JI, Sg = Object.prototype, KB = Sg.hasOwnProperty, OB = Sg.toString, SA = PI ? PI.toStringTag : void 0;
function zB(I) {
  var A = KB.call(I, SA), g = I[SA];
  try {
    I[SA] = void 0;
    var B = !0;
  } catch {
...
var TB = zB, jB = Object.prototype, _B = jB.toString;
function XB(I) {
  return _B.call(I);
}
var ZB = XB, VI = JI, PB = TB, VB = ZB, WB = "[object Null]", $B = "[object Undefined]", WI = VI ? VI.toStringTag : void 0;
function At(I) {
  return I == null ? I === void 0 ? $B : WB : WI && WI in Object(I) ? PB(I) : VB(I);
}
var bA = At;
function It(I, A) {
  return function(g) {
...
var gt = It, Bt = gt, tt = Bt(Object.getPrototypeOf, Object), Rg = tt;
function et(I) {
  return I != null && typeof I == "object";
}
var dA = et, Qt = bA, Ct = Rg, it = dA, Et = "[object Object]", st = Function.prototype, nt = Object.prototype, Jg = st.toString, at = nt.hasOwnProperty, ot = Jg.call(Object);
function rt(I) {
  if (!it(I) || Qt(I) != Et)
    return !1;
  var A = Ct(I);
  if (A === null)
    return !0;
  var g = at.call(A, "constructor") && A.constructor;
  return typeof g == "function" && g instanceof g && Jg.call(g) == ot;
}
var CA = rt;
const $I = {
  dayjs(I, A) {
...
}, Dt = Fg, ut = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createSimpleData: v,
  dayjs: Dt,
  extractData: mI,
...
const St = typeof TextEncoder > "u" ? (0, module.require)("util").TextEncoder : TextEncoder;
let WA = new St("utf-8");
const Rt = typeof WA.encodeInto == "function" ? function(I, A) {
...
function fA(I, A, g) {
  ...
  if (Q !== B) {
    ...
    const C = VA().subarray(t + Q, t + B), E = Rt(I, C);
    Q += E.written;
  }
  return iA = Q, t;
}
const Jt = typeof TextDecoder > "u" ? (0, module.require)("util").TextDecoder : TextDecoder;
let Lg = new Jt("utf-8", { ignoreBOM: !0, fatal: !0 });
Lg.decode();
function iI(I, A) {
...
function Kt(I, A) {
  ...
  kt()[I / 8 + 1] = pI(B) ? 0 : B, gA()[I / 4 + 0] = !pI(B);
}
function Ot(I, A) {
...
URL = globalThis.URL;
const V = await Mt({ "./rich_wasm_bg.js": { __wbindgen_object_drop_ref: Ht, __wbindgen_number_new: bt, __wbindgen_is_object: xt, __wbindgen_jsval_loose_eq: vt, __wbindgen_boolean_get: qt, __wbindgen_number_get: Kt, __wbindgen_string_get: Ot, __wbindgen_error_new: zt, __wbg_get_27fe3dac1c4d0224: Tt, __wbg_length_e498fbc24f9c1d4f: jt, __wbg_new_b525de17f44a8943: _t, __wbindgen_is_function: Xt, __wbg_next_b7d530c04fd8b217: Zt, __wbg_next_88560ec06a094dea: Pt, __wbg_done_1ebec03bbd919843: Vt, __wbg_value_6ac8da5cc5b3efda: Wt, __wbg_iterator_55f114446221aa5a: $t, __wbg_get_baf4855f9a986186: Ae, __wbg_call_95d1ea488d03e4e8: Ie, __wbg_set_17224bc548dd1d7b: ge, __wbg_isArray_39d28997bf6b96b4: Be, __wbg_instanceof_ArrayBuffer_a69f02ee4c4f5065: te, __wbg_isSafeInteger_8c4789029e885159: ee, __wbg_buffer_cf65c07de34b9a08: Qe, __wbg_new_537b7341ce90bb31: Ce, __wbg_set_17499e8aa4003ebd: ie, __wbg_length_27a2afe8ab42b09f: Ee, __wbg_instanceof_Uint8Array_01cebe79ca606cca: se, __wbindgen_debug_string: ne, __wbindgen_throw: ae, __wbindgen_memory: oe } }, Gt), re = V.memory, ce = V.secretkey, he = V.validate, le = V.encrypt, De = V.decrypt, ue = V.__wbindgen_malloc, fe = V.__wbindgen_realloc, we = V.__wbindgen_add_to_stack_pointer, de = V.__wbindgen_free, ye = V.__wbindgen_exn_store, pe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  __wbindgen_add_to_stack_pointer: we,
  __wbindgen_exn_store: ye,
  __wbindgen_free: de,
  __wbindgen_malloc: ue,
...
const Ge = function(I) {
  ...
  let A = typeof I == "string" ? I : JSON.stringify(I), g = Ut(A);
  ...
  if (typeof I == "string")
    ...
    let g = await Ge(I), B = Array.prototype.slice.call(new Uint8Array(g));
    A = Lt(B);
  ...
  return typeof I == "string" && I.length > 2 && I.length < 16 ? mt(I) : null;
}, Ne = function(I, A) {
  return typeof I == "string" && typeof A == "string" ? Yt(I, A) : !1;
}, Fe = async function(I, A) {
  if (!I)
    return null;
...
var Se = oA, Re = Se.isFinite;
function Je(I) {
  return typeof I == "number" && Re(I);
}
var me = Je;
function Ye(I, A = {}) {
  let g = Object.assign({
...
class Ue extends DA {
  ...
  //    请求数据
  request(A) {
    this.status != "request" && (this.isloading = !0, this.status = "request", this.emit("request", this), Ye({
...
var He = Array.isArray, vA = He, be = bA, xe = dA, ve = "[object Symbol]";
function qe(I) {
  return typeof I == "symbol" || xe(I) && be(I) == ve;
}
var bI = qe, Ke = vA, Oe = bI, ze = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Te = /^\w*$/;
function je(I, A) {
  if (Ke(I))
    return !1;
  var g = typeof I;
  return g == "number" || g == "symbol" || g == "boolean" || I == null || Oe(I) ? !0 : Te.test(I) || !ze.test(I) || A != null && I in Object(A);
}
var _e = je;
function Xe(I) {
  var A = typeof I;
...
var rA = Xe, Ze = bA, Pe = rA, Ve = "[object AsyncFunction]", We = "[object Function]", $e = "[object GeneratorFunction]", AQ = "[object Proxy]";
function IQ(I) {
  if (!Pe(I))
    return !1;
  var A = Ze(I);
  return A == We || A == $e || A == Ve || A == AQ;
}
var xI = IQ, gQ = oA, BQ = gQ["__core-js_shared__"], tQ = BQ, lI = tQ, Ag = function() {
...
var QQ = eQ, CQ = Function.prototype, iQ = CQ.toString;
function EQ(I) {
  if (I != null) {
    try {
      return iQ.call(I);
...
var sQ = EQ, nQ = xI, aQ = QQ, oQ = rA, rQ = sQ, cQ = /[\\^$.*+?()[\]{}|]/g, hQ = /^\[object .+?Constructor\]$/, lQ = Function.prototype, DQ = Object.prototype, uQ = lQ.toString, fQ = DQ.hasOwnProperty, wQ = RegExp(
  "^" + uQ.call(fQ).replace(cQ, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function dQ(I) {
  if (!oQ(I) || aQ(I))
    return !1;
...
var GQ = pQ, MQ = yQ, NQ = GQ;
function FQ(I, A) {
  var g = NQ(I, A);
  return MQ(g) ? g : void 0;
}
var vI = FQ, kQ = vI, SQ = kQ(Object, "create"), EI = SQ, Ig = EI;
function RQ() {
...
var YQ = mQ, UQ = EI, LQ = "__lodash_hash_undefined__", HQ = Object.prototype, bQ = HQ.hasOwnProperty;
function xQ(I) {
  var A = this.__data__;
  if (UQ) {
    var g = A[I];
    return g === LQ ? void 0 : g;
  }
  return bQ.call(A, I) ? A[I] : void 0;
}
var vQ = xQ, qQ = EI, KQ = Object.prototype, OQ = KQ.hasOwnProperty;
function zQ(I) {
  var A = this.__data__;
  return qQ ? A[I] !== void 0 : OQ.call(A, I);
}
var TQ = zQ, jQ = EI, _Q = "__lodash_hash_undefined__";
function XQ(I, A) {
  var g = this.__data__;
  return this.size += this.has(I) ? 0 : 1, g[I] = jQ && A === void 0 ? _Q : A, this;
}
var ZQ = XQ, PQ = JQ, VQ = YQ, WQ = vQ, $Q = TQ, AC = ZQ;
function yA(I) {
...
yA.prototype.clear = PQ;
yA.prototype.delete = VQ;
yA.prototype.get = WQ;
yA.prototype.has = $Q;
yA.prototype.set = AC;
var IC = yA;
...
var nI = QC, CC = nI, iC = Array.prototype, EC = iC.splice;
function sC(I) {
  var A = this.__data__, g = CC(A, I);
  if (g < 0)
    return !1;
  var B = A.length - 1;
  return g == B ? A.pop() : EC.call(A, g, 1), --this.size, !0;
}
var nC = sC, aC = nI;
function oC(I) {
  var A = this.__data__, g = aC(A, I);
  return g < 0 ? void 0 : A[g][1];
}
var rC = oC, cC = nI;
function hC(I) {
  return cC(this.__data__, I) > -1;
}
var lC = hC, DC = nI;
function uC(I, A) {
  var g = this.__data__, B = DC(g, I);
  return B < 0 ? (++this.size, g.push([I, A])) : g[B][1] = A, this;
}
var fC = uC, wC = BC, dC = nC, yC = rC, pC = lC, GC = fC;
function pA(I) {
  var A = -1, g = I == null ? 0 : I.length;
  for (this.clear(); ++A < g; ) {
    var B = I[A];
...
pA.prototype.clear = wC;
pA.prototype.delete = dC;
pA.prototype.get = yC;
pA.prototype.has = pC;
pA.prototype.set = GC;
var aI = pA, MC = vI, NC = oA, FC = MC(NC, "Map"), bg = FC, gg = IC, kC = aI, SC = bg;
function RC() {
...
function LC(I, A) {
  var g = I.__data__;
  return UC(A) ? g[typeof A == "string" ? "string" : "hash"] : g.map;
}
var oI = LC, HC = oI;
function bC(I) {
...
var KC = qC, OC = oI;
function zC(I) {
  return OC(this, I).has(I);
}
var TC = zC, jC = oI;
function _C(I, A) {
  var g = jC(this, I), B = g.size;
  return g.set(I, A), this.size += g.size == B ? 0 : 1, this;
}
var XC = _C, ZC = JC, PC = xC, VC = KC, WC = TC, $C = XC;
function GA(I) {
  var A = -1, g = I == null ? 0 : I.length;
  for (this.clear(); ++A < g; ) {
    var B = I[A];
...
GA.prototype.clear = ZC;
GA.prototype.delete = PC;
GA.prototype.get = VC;
GA.prototype.has = WC;
GA.prototype.set = $C;
var xg = GA, vg = xg, Ai = "Expected a function";
function qI(I, A) {
...
qI.Cache = vg;
var Ii = qI, gi = Ii, Bi = 500;
function ti(I) {
  var A = gi(I, function(B) {
    return g.size === Bi && g.clear(), B;
  }), g = A.cache;
  return A;
}
var ei = ti, Qi = ei, Ci = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, ii = /\\(\\)?/g, Ei = Qi(function(I) {
  var A = [];
  return I.charCodeAt(0) === 46 && A.push(""), I.replace(Ci, function(g, B, t, e) {
    A.push(t ? e.replace(ii, "$1") : B || g);
  }), A;
}), si = Ei;
function ni(I, A) {
...
var ai = ni, Bg = JI, oi = ai, ri = vA, ci = bI, hi = 1 / 0, tg = Bg ? Bg.prototype : void 0, eg = tg ? tg.toString : void 0;
function qg(I) {
  if (typeof I == "string")
    return I;
  if (ri(I))
  ...
  if (ci(I))
    return eg ? eg.call(I) : "";
  var A = I + "";
  return A == "0" && 1 / I == -hi ? "-0" : A;
}
var li = qg, Di = li;
function ui(I) {
  return I == null ? "" : Di(I);
}
var fi = ui, wi = vA, di = _e, yi = si, pi = fi;
function Gi(I, A) {
  return wi(I) ? I : di(I, A) ? [I] : yi(pi(I));
}
var Mi = Gi, Ni = bI, Fi = 1 / 0;
function ki(I) {
  if (typeof I == "string" || Ni(I))
    return I;
  var A = I + "";
  return A == "0" && 1 / I == -Fi ? "-0" : A;
}
var Si = ki, Ri = Mi, Ji = Si;
function mi(I, A) {
  A = Ri(A, I);
...
class Hi extends DA {
  constructor(A, g = {}) {
    ...
    this.appData = g, this.AppSetup = g.AppSetup, this.AppInfo = g.info, this.id = B || "RD_" + z(10), this.url = t, this.body = Q, this.method = C, this.data = L({}), this.sourceData = null, this.loading = Gg(!1), this.isloading = !1, this.itval = E || 0, this.it = null, this.status = "wait", this.err = null, this.extractRule = e ? L(e) : L({});
    let s = Le({ url: t, body: NI.call(this, Q), method: C }, this.AppInfo.network);
    s.on("request", () => {
  ...
  setData(A = {}) {
    A.url && (this.url = A.url, this.req.options.url = A.url), A.method && (this.method = A.method, this.req.options.method = A.method), A.body && (this.body = A.body, this.req.options.body = NI.call(this.appData, A.body)), me(A.itval) && (this.itval = A.itval);
  }
  // 修改规则
  setExtractRule(A) {
...
const S = {}, LA = L([]), Kg = function() {
  ...
  remotes: S,
  requestData: zg
}, Symbol.toStringTag, { value: "Module" })), qi = function(I) {
  ...
  return {
    ...
    name: B,
    type: t,
    value: g instanceof Object ? L(g) : Gg(g),
...
class AE {
  ...
  // -------------------
  constructor(A, g) {
    this.AppSetup = A.app.AppSetup, this.component = A.app.component, this.modules = new Xi(this), this.groups = new Zi(this), this.sprites = new Pi(this), g && this.fillData(g);
  }
  // 填充数据
  fillData(A) {
    Wi.call(this, A);
...
class iE {
  ...
  filterDatas = {};
  constructor(A, g) {
    this.app = A, Object.assign(this.AppSetup, g), this.scale = L({ value: 1, h: 1, w: 1 }), this.transform = eE.call(this), this.mData = new AE(this), this.aData = new IE(this), this.rData = new BE(this), this.gData = new gE(this), this.pData = new tE(this);
  }
  init(A) {
  ...
  // 清除所有数据
  clearDataAll() {
    this.mData.clearData(), this.aData.clearData(), this.gData.clearData(), this.rData.clearData(), this.pData.clearData(), QE.call(this);
  }
}
function KI(I, A) {
...
function FI(I) {
  ...
  return t && (e = {
    ...
    switch (Q.event) {
      case "click":
        Object.assign(e, EE.call(A, Q, B));
        break;
      case "timeout":
        Object.assign(e, nE.call(A, Q, B));
        break;
      case "interval":
        Object.assign(e, aE.call(A, Q, B));
        break;
      default:
        Object.assign(e, sE.call(A, Q, B, t));
    }
...
function T(I) {
  ...
  if (Q ? (C = oB(Q), C == Q && (console.warn(C + "组件没有找到"), C = "div")) : (console.warn("数据缺少组件" + g), C = "div"), typeof g == "string") {
    ...
    return E.ref = E.id, E.name && delete E.name, E.mid && delete E.mid, U(C, E, B);
  } else
    return U(C, {}, "");
}
const oE = {
...
function _g(I, { id: A, myApp: g }) {
  const B = rE(I), t = FI({ myApp: g, events: I.events || [], data: I, componentName: "" }), e = ["element_sprite", { element_selected: I.selected }, { element_hover: I.hover }];
...
const ZA = function(I, A, g, B) {
  ...
  setup(I, A) {
    ...
    return cE(g, I), () => {
      const Q = t.getElement(I.id);
      let C = _g(Q, { id: I.id, myApp: { AppSetup: B, data: t, component: e } }), E = T({ name: Q.name, props: Q.id });
      return g.value = U("div", C, E), g.value;
    };
  }
}, Xg = {
  name: "vx-sprite-group",
  ...
  props: ["components"],
  setup(I) {
    const { components: A } = hB(I);
    return (g) => {
      const B = [];
      return A.value && A.value.forEach((t, e) => {
        t.visible && (t.type == "group" ? B.push(U(Xg, { id: t.id })) : B.push(U(OI, { id: t.id })));
      }), U("div", {
        id: g.id,
        style: g.style
      }, B);
...
const ME = {
  ...
  setup() {
    ...
    return () => I.length > 0 ? U("div", {
      id: "vx-message",
      style: sg
    }, I.map((g) => U("div", { class: "message_item", style: GE }, g))) : U("div", {
      id: "vx-message",
      style: sg
    });
  }
...
const kE = {
  ...
  setup(I) {
    return () => {
      let A = Object.assign({}, FE, I.style);
      return U("div", {
        id: "vx-background",
        style: A,
        onmousedown: (g) => {
...
}, SE = [hE, lE, DE, pE, fE, dE, ME, NE, kE, Xg, OI], RE = {
  install: (I) => {
    SE.forEach((A) => {
...
var vE = xE, qE = aI, KE = bg, OE = xg, zE = 200;
function TE(I, A) {
  var g = this.__data__;
  if (g instanceof qE) {
    var B = g.__data__;
    ...
    g = this.__data__ = new OE(B);
  }
  return g.set(I, A), this.size = g.size, this;
}
var jE = TE, _E = aI, XE = YE, ZE = LE, PE = bE, VE = vE, WE = jE;
function MA(I) {
  var A = this.__data__ = new _E(I);
  this.size = A.size;
}
MA.prototype.clear = XE;
MA.prototype.delete = ZE;
MA.prototype.get = PE;
MA.prototype.has = VE;
MA.prototype.set = WE;
var $E = MA, As = vI, Is = function() {
  try {
...
var zI = gs, Bs = zI, ts = sI;
function es(I, A, g) {
  (g !== void 0 && !ts(I[A], g) || g === void 0 && !(A in I)) && Bs(I, A, g);
}
var Pg = es;
function Qs(I) {
...
var Cs = Qs, is = Cs, Es = is(), ss = Es, tI = {}, ns = {
  get exports() {
    return tI;
  },
  set exports(I) {
...
var as = oA, os = as.Uint8Array, rs = os, ag = rs;
function cs(I) {
...
var ws = fs, ds = rA, og = Object.create, ys = function() {
  function I() {
  }
  return function(A) {
    if (!ds(A))
...
}(), ps = ys, Gs = Object.prototype;
function Ms(I) {
  var A = I && I.constructor, g = typeof A == "function" && A.prototype || Gs;
  return I === g;
}
var Vg = Ms, Ns = ps, Fs = Rg, ks = Vg;
function Ss(I) {
  return typeof I.constructor == "function" && !ks(I) ? Ns(Fs(I)) : {};
}
var Rs = Ss, Js = bA, ms = dA, Ys = "[object Arguments]";
function Us(I) {
  return ms(I) && Js(I) == Ys;
}
var Ls = Us, rg = Ls, Hs = dA, Wg = Object.prototype, bs = Wg.hasOwnProperty, xs = Wg.propertyIsEnumerable, vs = rg(function() {
  return arguments;
}()) ? rg : function(I) {
  return Hs(I) && bs.call(I, "callee") && !xs.call(I, "callee");
}, $g = vs, qs = 9007199254740991;
function Ks(I) {
  return typeof I == "number" && I > -1 && I % 1 == 0 && I <= qs;
}
var AB = Ks, Os = xI, zs = AB;
function Ts(I) {
  return I != null && zs(I.length) && !Os(I);
}
var TI = Ts, js = TI, _s = dA;
function Xs(I) {
  return _s(I) && js(I);
}
var Zs = Xs, HA = {}, Ps = {
...
var Ws = Vs;
(function(I, A) {
  var g = oA, B = Ws, t = A && !A.nodeType && A, e = t && !0 && I && !I.nodeType && I, Q = e && e.exports === t, C = Q ? g.Buffer : void 0, E = C ? C.isBuffer : void 0, s = E || B;
  I.exports = s;
})(Ps, HA);
var $s = bA, An = AB, In = dA, gn = "[object Arguments]", Bn = "[object Array]", tn = "[object Boolean]", en = "[object Date]", Qn = "[object Error]", Cn = "[object Function]", En = "[object Map]", sn = "[object Number]", nn = "[object Object]", an = "[object RegExp]", on = "[object Set]", rn = "[object String]", cn = "[object WeakMap]", hn = "[object ArrayBuffer]", ln = "[object DataView]", Dn = "[object Float32Array]", un = "[object Float64Array]", fn = "[object Int8Array]", wn = "[object Int16Array]", dn = "[object Int32Array]", yn = "[object Uint8Array]", pn = "[object Uint8ClampedArray]", Gn = "[object Uint16Array]", Mn = "[object Uint32Array]", R = {};
R[Dn] = R[un] = R[fn] = R[wn] = R[dn] = R[yn] = R[pn] = R[Gn] = R[Mn] = !0;
R[gn] = R[Bn] = R[hn] = R[tn] = R[ln] = R[en] = R[Qn] = R[Cn] = R[En] = R[sn] = R[nn] = R[an] = R[on] = R[rn] = R[cn] = !1;
function Nn(I) {
  return In(I) && An(I.length) && !!R[$s(I)];
}
var Fn = Nn;
function kn(I) {
  return function(A) {
...
var Jn = Fn, mn = Sn, cg = eI, hg = cg && cg.isTypedArray, Yn = hg ? mn(hg) : Jn, IB = Yn;
function Un(I, A) {
  if (!(A === "constructor" && typeof I[A] == "function") && A != "__proto__")
    return I[A];
}
var gB = Un, Ln = zI, Hn = sI, bn = Object.prototype, xn = bn.hasOwnProperty;
function vn(I, A, g) {
  var B = I[A];
  (!(xn.call(I, A) && Hn(B, g)) || g === void 0 && !(A in I)) && Ln(I, A, g);
}
var qn = vn, Kn = qn, On = zI;
function zn(I, A, g, B) {
  var t = !g;
  g || (g = {});
  for (var e = -1, Q = A.length; ++e < Q; ) {
    var C = A[e], E = B ? B(g[C], I[C], C, g, I) : void 0;
    E === void 0 && (E = I[C]), t ? On(g, C, E) : Kn(g, C, E);
  }
  return g;
}
var Tn = zn;
...
var _n = jn, Xn = 9007199254740991, Zn = /^(?:0|[1-9]\d*)$/;
function Pn(I, A) {
  var g = typeof I;
  return A = A ?? Xn, !!A && (g == "number" || g != "symbol" && Zn.test(I)) && I > -1 && I % 1 == 0 && I < A;
}
var BB = Pn, Vn = _n, Wn = $g, $n = vA, Aa = HA, Ia = BB, ga = IB, Ba = Object.prototype, ta = Ba.hasOwnProperty;
function ea(I, A) {
  var g = $n(I), B = !g && Wn(I), t = !g && !B && Aa(I), e = !g && !B && !t && ga(I), Q = g || B || t || e, C = Q ? Vn(I.length, String) : [], E = C.length;
  for (var s in I)
    (A || ta.call(I, s)) && !(Q && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var ia = Ca, Ea = rA, sa = Vg, na = ia, aa = Object.prototype, oa = aa.hasOwnProperty;
function ra(I) {
  if (!Ea(I))
    return na(I);
  var A = sa(I), g = [];
  for (var B in I)
    B == "constructor" && (A || !oa.call(I, B)) || g.push(B);
  return g;
}
var ca = ra, ha = Qa, la = ca, Da = TI;
function ua(I) {
  return Da(I) ? ha(I, !0) : la(I);
}
var tB = ua, fa = Tn, wa = tB;
function da(I) {
  return fa(I, wa(I));
}
var ya = da, lg = Pg, pa = tI, Ga = us, Ma = ws, Na = Rs, Dg = $g, ug = vA, Fa = Zs, ka = HA, Sa = xI, Ra = rA, Ja = CA, ma = IB, fg = gB, Ya = ya;
function Ua(I, A, g, B, t, e, Q) {
  ...
  if (a) {
    var r = ug(E), y = !r && ka(E), d = !r && !y && ma(E);
    n = E, r || y || d ? ug(C) ? n = C : Fa(C) ? n = Ma(C) : y ? (a = !1, n = pa(E, !0)) : d ? (a = !1, n = Ga(E, !0)) : n = [] : Ja(E) || Dg(E) ? (n = C, Dg(C) ? n = Ya(C) : (!Ra(C) || Sa(C)) && (n = Na(E))) : a = !1;
  }
  a && (Q.set(E, n), t(n, E, B, e, Q), Q.delete(E)), lg(I, g, n);
}
var La = Ua, Ha = $E, ba = Pg, xa = ss, va = La, qa = rA, Ka = tB, Oa = gB;
function eB(I, A, g, B, t) {
  I !== A && xa(A, function(e, Q) {
    if (t || (t = new Ha()), qa(e))
      va(I, A, Q, g, eB, B, t);
    else {
      var C = B ? B(Oa(I, Q), e, Q + "", I, A, t) : void 0;
      C === void 0 && (C = e), ba(I, Q, C);
    }
  }, Ka);
}
var za = eB;
...
var Wa = Va, $a = Wa, dg = Zg, Ao = QB, Io = dg ? function(I, A) {
...
} : Ao, go = Io, Bo = 800, to = 16, eo = Date.now;
function Qo(I) {
  var A = 0, g = 0;
  return function() {
    var B = eo(), t = to - (B - g);
...
var Co = Qo, io = go, Eo = Co, so = Eo(io), no = so, ao = QB, oo = Pa, ro = no;
function co(I, A) {
  return ro(oo(I, A, ao), I + "");
}
var ho = co, lo = sI, Do = TI, uo = BB, fo = rA;
function wo(I, A, g) {
  if (!fo(g))
    return !1;
  var B = typeof A;
  return (B == "number" ? Do(g) && uo(A, g.length) : B == "string" && A in g) ? lo(g[A], I) : !1;
}
var yo = wo, po = ho, Go = yo;
function Mo(I) {
  return po(function(A, g) {
    var B = -1, t = g.length, e = t > 1 ? g[t - 1] : void 0, Q = t > 2 ? g[2] : void 0;
    for (e = I.length > 3 && typeof e == "function" ? (t--, e) : void 0, Q && Go(g[0], g[1], Q) && (e = t < 3 ? void 0 : e, t = 1), A = Object(A); ++B < t; ) {
      var C = g[B];
      C && I(A, C, B, e);
    }
    return A;
...
var No = Mo, Fo = za, ko = No, So = ko(function(I, A, g) {
  Fo(I, A, g);
}), yg = So;
class Ro {
  app = null;
...
class Ar extends DA {
  constructor(A = {}) {
    super(), this.id = A.id || z(10), this.vapp = null, this.dom = null, this.component = new Ro(this), this.data = new iE(this, A.config), this.controller = Uo(this), this.AppSetup = this.data.AppSetup, this.helper = new Zo(this);
  }
  async initData(A) {
    let g = await HI(A);
    return this.id = g.id, g && Array.isArray(g.plugins) && await $o.call(this, g.plugins), this.data.init(g), {
...
const tr = ut, er = ke, Qr = p, Cr = xA, Ir = m, ir = vi, Er = function(I, { display: A, components: g, actions: B, slots: t, data: e }) {
  let Q = new Ar({ config: I });
  return g && Q.use(g), B && Q.use(B), Q.create({ slots: t }), e && Q.initData(e).then((C) => {
    C && A == !0 && Q.display();
  }), Q;
};
SB.addEventListener("statechange", function(I) {
  p.emit(Ir.PAGE_STATE, { state: I.newState, oldState: I.oldState });
});
