<template><div><h1 id="动作管理" tabindex="-1"><a class="header-anchor" href="#动作管理" aria-hidden="true">#</a> 动作管理</h1>
<p>数据没有所有事件的集中管理，所有的事件都是和对用的元件对象相关联。</p>
<h2 id="动作数据对象" tabindex="-1"><a class="header-anchor" href="#动作数据对象" aria-hidden="true">#</a> 动作数据对象</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="获取所有动作" tabindex="-1"><a class="header-anchor" href="#获取所有动作" aria-hidden="true">#</a> 获取所有动作</h2>
<ul>
<li>获取动作集合<br>
此对象是一个reactive的响应对象，以动作id作为键的集合</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="添加新动作" tabindex="-1"><a class="header-anchor" href="#添加新动作" aria-hidden="true">#</a> 添加新动作</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>helper<span class="token punctuation">,</span>typeModel<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="自定义动作方法" tabindex="-1"><a class="header-anchor" href="#自定义动作方法" aria-hidden="true">#</a> 自定义动作方法</h2>
<p>默认的几个动作也许无法满足开发需求，现在你可以创建一个自己的动作插件，让动作更丰富多彩。<br>
<strong>动作包含的基本特性</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> controller <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'rd-runtime'</span>
